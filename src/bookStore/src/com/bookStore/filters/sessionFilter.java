...
//                        value = "/user.do?null,/page.do?operate=page&page=user/regist,/user.do?operate=logOut,/page.do?operate=page&page=user/login,/user.do?null,/user.do?operate=cookieLogin")
//        })
